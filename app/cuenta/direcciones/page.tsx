      ...
      <div className="container py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-12 text-center">
            ...
            <button className="inline-flex items-center px-6 py-3 bg-bloom-primary text-white rounded-lg font-medium hover:bg-bloom-primary/90 transition-colors">
              <Plus className="w-5 h-5 mr-2" />
              Añadir Dirección
            </button>
          </div>

          {/* TODO: Aquí irá la gestión de direcciones cuando esté implementado el sistema */}
        </div>
      </div>
    </div>
  )
